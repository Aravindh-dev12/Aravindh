...
export function Writing() {
  const hasPosts = site.writing && site.writing.length > 0;
    ...
    <div id="writing">
      ...
      <Shell>
        {hasPosts ? (
          ...
          >
            <div>
              <p className="font-serif text-[18px] text-[var(--fg)]">Read my writing on Medium</p>
              <p className="mt-1 text-[13px] text-[var(--muted)]">Latest articles and posts from my Medium profile.</p>
            </div>
